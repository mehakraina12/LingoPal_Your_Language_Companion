...
const questions = [
    {
        question: "What is the Odia term for 'ଖାଇବା ଶୁରୁ କରିବୁ'?",
        answers: [
    ...
    {
        question: "How do you say 'କ୍ଷମା କରନ୍ତୁ, ଟୋଇଲେଟ କୁଥି ଅଛି?' in English?",
        answers: [
    ...
    {
        question: "What does 'ଖୁସି ମିଳିବାରେ ଫିରି ଆସୁଛି' mean in English?",
        answers: [
    ...
    {
        question: "Which phrase translates to 'ସମାଧାନ ମିଳିଲା' in English?",
        answers: [
    ...
    {
        question: "What is the meaning of 'କୃପା କରି' in English?",
        answers: [
